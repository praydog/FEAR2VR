# Reversing lessons -- the craft, and how it goes wrong here

Accumulated technique and failure modes. Every entry was paid for; most record a specific wrong
answer this project published and then had to retract.

- The recipe these support: `MAPPING_WORKFLOW.MD`.
- What they established about the game: `ENGINE_NOTES.md`.

Two things to know before reading:

- **A lesson here usually exists because the mistake looked RIGHT.** The value is in the tell --
...
- [Hardware watchpoints](#hardware-watchpoints) -- 2
- [ReGenny and codegen](#regenny-and-codegen) -- 2
- [The suite](#the-suite) -- 11
- [The harness](#the-harness) -- 3
- [Crash reporting](#crash-reporting) -- 2
- [Phase 1 technique notes: IDA static reversing](#phase-1-technique-notes-ida-static-reversing)
- [Phase 2 technique notes: live verification](#phase-2-technique-notes-live-verification)
- [Gotchas log](#gotchas-log)
...
## Phase 1 technique notes: IDA static reversing

How to identify what a function or field IS, and the attribution errors that recur.
...
How to prove a layout against the running game, and how each shortcut fails.
