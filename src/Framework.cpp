    ...
    handlers.xr = [](const std::string& request_target) {
        ...
        std::string out;
        {
            ...
            jf.b("ok", true)
              ...
              .f("vr_obj_x", sdk::PlayerMgr::object_position(0).value_or(std::array<float,3>{})[0], 2)
              .f("vr_obj_y", sdk::PlayerMgr::object_position(0).value_or(std::array<float,3>{})[1], 2)
              .f("vr_obj_z", sdk::PlayerMgr::object_position(0).value_or(std::array<float,3>{})[2], 2)
              .f("vr_ppos_x", sdk::PlayerMgr::movement_state(0).value_or(sdk::PlayerMgr::MovementState{}).cached_position[0], 2)
              .f("vr_ppos_y", sdk::PlayerMgr::movement_state(0).value_or(sdk::PlayerMgr::MovementState{}).cached_position[1], 2)
              .f("vr_ppos_z", sdk::PlayerMgr::movement_state(0).value_or(sdk::PlayerMgr::MovementState{}).cached_position[2], 2)
              ...
              .f("vr_pin_y", VR::get().pin_contribution()[1], 2)
              .f("vr_pin_z", VR::get().pin_contribution()[2], 2)
              .f("vr_room_x", VR::get().room_contribution()[0], 2)
              .f("vr_room_y", VR::get().room_contribution()[1], 2)
              .f("vr_room_z", VR::get().room_contribution()[2], 2)
              .b("vr_eyeref_ready", VR::get().eye_reference_captured())
              .b("vr_head_neutral", VR::get().head_is_neutral())
              .b("vr_pitch_level", VR::get().head_neutrality().pitch_level)
              .f("vr_eyelive_x", sdk::PlayerMgr::eye_offset(0).value_or(std::array<float,3>{})[0], 2)
              .f("vr_eyelive_y", sdk::PlayerMgr::eye_offset(0).value_or(std::array<float,3>{})[1], 2)
              .f("vr_eyelive_z", sdk::PlayerMgr::eye_offset(0).value_or(std::array<float,3>{})[2], 2)
              .f("vr_eyeref_x", VR::get().eye_reference()[0], 2)
              .f("vr_eyeref_y", VR::get().eye_reference()[1], 2)
              .f("vr_eyeref_z", VR::get().eye_reference()[2], 2)
              ...
              .f("rot_sum_axis", FrameCapture::get().rot_sum_axis(), 3)
              .f("rot_axis_worst", FrameCapture::get().rot_axis_worst(), 3)
              .u("aim_samples", static_cast<size_t>(FrameCapture::get().aim_samples()))
              .f("aim_sum", FrameCapture::get().aim_sum(), 3)
              .f("aim_worst", FrameCapture::get().aim_worst(), 3)
              .u("aim_still_samples", static_cast<size_t>(FrameCapture::get().aim_still_samples()))
              .f("aim_still_sum", FrameCapture::get().aim_still_sum(), 3)
              .u("rot_axis_bad", static_cast<size_t>(FrameCapture::get().rot_axis_bad()))
              ...
              .u("cp_view_checks", static_cast<size_t>(CameraPassHook::view_check_samples()))
              .u("cp_view_mismatch", static_cast<size_t>(CameraPassHook::view_mismatch_frames()))
              .u("cp_vm_left", static_cast<size_t>(CameraPassHook::view_mismatch_left()))
              .u("cp_vm_right", static_cast<size_t>(CameraPassHook::view_mismatch_right()))
              .u("cp_vm_after_aux", static_cast<size_t>(CameraPassHook::mismatch_after_aux()))
              .u("cp_frames_2main", static_cast<size_t>(CameraPassHook::frames_two_main()))
              .u("cp_frames_other_main", static_cast<size_t>(CameraPassHook::frames_other_main()))
              .u("cp_main_worst", static_cast<size_t>(CameraPassHook::main_worst()))
              .f("cp_view_mismatch_deg", CameraPassHook::view_mismatch_worst(), 3)
              ...
              .f("fp_gap_mean_ms", FramePublisher::get().gap_mean_ms(), 3)
            ...
            jf.b("fr_hooked", fr.hooked())
              ...
              .u("ak_no_name", static_cast<size_t>(AmmoKeeper::get().no_ammo_name()))
              .u("ak_no_count", static_cast<size_t>(AmmoKeeper::get().no_count()))
              .u("ak_satisfied", static_cast<size_t>(AmmoKeeper::get().satisfied()))
              .u("ak_asked", static_cast<size_t>(AmmoKeeper::get().asked()))
